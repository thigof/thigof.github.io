      ...
      <fieldset class="q-mt-lg q-mb-lg">
        <div class="row flex">
          <div class="form-group">
            <select v-model="form.searchColumn">
              <option v-for="item in data.fields" :key="item" :value="item">{{ item }}</option>
            </select>
          </div>
          <div class="form-group">
            <input style="width: auto;" type="text" v-model="form.search1" placeholder="Pesquisar" />
          </div>
          <div class="form-group">
            <input style="width: auto;" type="text" v-model="form.search2" placeholder="Detalhes" />
          </div>
        </div>
        <q-table bordered
          :rows="data.values.filter(e => form.search1 && e && e[form.searchColumn]?.includes(form.search1))"
          :columns="data.colunas" row-key="NRPATRIMONIO1"></q-table>
      </fieldset>
